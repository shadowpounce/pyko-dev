        ...
        <div className={styles.footer}>
          <div className={styles.footerLeft}>
            <BodyText animationDelay={bodyTextDelay} lineHeight="130%">
              There are two kinds of students: those who react, and <br /> those
              who predict. Pyko gives you foresight, real-time <br /> insight,
              adaptive analytics, and intelligenc.
            </BodyText>
