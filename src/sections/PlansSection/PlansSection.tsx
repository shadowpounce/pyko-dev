...
export const PlansSection: React.FC<PlansSectionProps> = ({ sectionIndex }) => {
    ...
    useEffect(() => {
        ...
        // Cleanup: kill all desktop tweens on unmount
        return () => {
            const desktopRefs = [
                card1Ref, card2Ref, card1NameRef, card1PriceRef, card1MonthRef,
                card1HeaderRef, card1Feature1Ref, card1Feature2Ref, card1Feature3Ref,
                card1PlaceholderRef, card1ButtonRef, card1FooterRef,
                card2NameRef, card2PriceRef, card2MonthRef, card2HeaderRef,
                card2Feature1Ref, card2Feature2Ref, card2Feature3Ref,
                card2PlaceholderRef, card2ButtonRef, card2FooterRef
            ]
    ...
    useEffect(() => {
        ...
        // Cleanup: kill all mobile tweens on unmount
        return () => {
            const mobileRefs = [
                card1MobileRef, card2MobileRef, card1MobileNameRef, card1MobilePriceRef,
                card1MobileMonthRef, card1MobileHeaderRef, card1MobileFeature1Ref,
                card1MobileFeature2Ref, card1MobileFeature3Ref, card1MobilePlaceholderRef,
                card1MobileButtonRef, card1MobileFooterRef, card2MobileNameRef,
                card2MobilePriceRef, card2MobileMonthRef, card2MobileHeaderRef,
                card2MobileFeature1Ref, card2MobileFeature2Ref, card2MobileFeature3Ref,
                card2MobilePlaceholderRef, card2MobileButtonRef, card2MobileFooterRef
            ]
